        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul id="myTab" class="nav nav-tabs nav-justified">
                    <li class=""><a href="#service-three" data-toggle="tab"> Perlengkapan rumah tangga</a>
                    </li>
                </ul>
                    <div class="tab-pane fade" id="service-three">
                        <h4>alat-alat rumah tangga</h4>
                        <p>Kami menyediakan berbagai macam alat-alat rumah tangga.</p>
                        <div class="row">
