...
<body>
    ...
    <div class="container">
        ...
        $username = $_POST['message'];
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM kontak WHERE email='$no_telp'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO kontak(name, phone, email, message)
															VALUES('$nama', '$alamat', '$no_telp', '$username')") or die(mysqli_error());
						if($insert){
							echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Pesan Terkirim !</div>';
						}else{
            ...
            <div class="col-md-8">
                ...
                <form method="post" action="contact.php ">
                    ...
                    <input type="submit" name="input" class="btn btn-primary" value="Send Message" />
                </form>
            </div>
<div class="col-md-4">
                <h3>Detail Kontak</h3>
                ...
                <p><i class="fa fa-road"></i> 
                    <abbr title="Phone"></abbr>:jl kertayasa dukuh Bojong <br>RT 02 RW 01 Desa Sumberadi<br>Kode Pos 54317 Kec. Kebumen Kab. Kebumen</p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone"></abbr>: 08576783268</p>
            
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours"></abbr>: senin - sabtu : 9:00 AM to 9:00 PM</p>
